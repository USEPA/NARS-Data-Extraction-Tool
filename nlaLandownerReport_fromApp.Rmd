...
verification <- subset(params[['userDataRMD']][['VERIFICATION']][[1]], PARAMETER %in% c('SITE_ID','VISIT_NO', "DATE_COL","LOC_NAME",                                                        "GEN_COM","CREW_LEADER"), select = c('PARAMETER','RESULT')) 
  
verification_tbl <- subset(verification, !(PARAMETER %in% c("CREW")))
...
## National Lakes Assessment Landowner Report
