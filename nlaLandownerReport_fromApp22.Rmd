...
if(sampled=='YES' & !is.null(params[['userDataRMD']][['LITTORAL']])){
  littoral <- data.frame(Sample = c('BENT','ENTE'), 
                         ...
                         Description = c('Benthic macroinvertebrate composition','*E.coli* and enterococci'))
...
if(sampled=='YES' & !is.null(params[['userDataRMD']][['PROFILE']])){
  ...
  profile_tbl.wide <- subset(profile_tbl.wide, select = c('DEPTH','OXYGEN','TEMPERATURE','PH','CONDUCTIVITY', 'METALIMNION'))
