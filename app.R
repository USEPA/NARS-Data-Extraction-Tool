...
ui <- fluidPage(
   ...
   navbarPage("NARS Rapid Data Extraction and Reporting Tool (v. 0.1)",
              ...
              tabPanel(span('Select Survey', title='Select the survey for which you want to extract data'),
                       column(6,(radioButtons('survey',"Select survey app used (select one):",
                                    choices = c('National Rivers and Streams Assessment (NRSA) 2018-19' = 'nrsa1819',
                                                'National Lakes Assessment (NLA) 2017' = 'nla17',
                                                'National Coastal Condition Assessment (NCCA) 2020' = 'ncca20'),
                                    select = 'srs')))),
